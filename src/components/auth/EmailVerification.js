...
export const EmailVerification = () => {
  ...
  const handleResend = () => {
    // Логіка для повторного надсилання електронного листа
    alert("Verification email resent to your inbox. Please check!");
  };
    ...
    return (
      <div className="email-verification-overlay">
        <div className="email-verification-box">
          ...
          <p className="message-text">Please wait while we verify your information.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="email-verification-overlay">
      <div className="email-verification-box">
        ...
        <p className="message-text">
          We've sent a verification link to your email{" "}
          <span className="user-email">{user ? user.email : "loading"}</span>.
          Please check your inbox and click the button to verify your email. Once verified, you’ll be set to explore the platform!
        </p>
        ...
        <div className="resend-section">
          ...
          <p className="support-text">
            Can’t find the email? Check your spam or promotions folder, or{" "}
            <Link className="support-link">resend it here</Link>.
          </p>
        </div>
      </div>
    </div>
